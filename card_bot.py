...
bot = TeleBot(token='5498487266:AAGZEsE7PMemsErcZHK4sPs_52Zwa99SRIk', parse_mode='html') # создание бота
...
def start_command_handler(message: types.Message):
    ...
    bot.send_message(
        ...
        text='Пепе умеет генерировать номера банковских карт, нужно только попросить\nВыбери тип карты:', # текст сообщения
